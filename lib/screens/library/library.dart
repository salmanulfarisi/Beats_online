...
import 'package:beats_online/methods/get_time_ago.dart';
import 'package:beats_online/methods/snackbar.dart';
import 'package:beats_online/screens/liked_songs/liked_songs.dart';
import 'package:beats_online/screens/playlist/playlist_songs.dart';
import 'package:beats_online/screens/recently_played/recently_played.dart';
...
class Library extends StatelessWidget {
  ...
  const Library({Key? key, required this.con}) : super(key: key);
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => RecentlyPlayedSongs(con: con)));
              },
              child: Padding(
                padding:
                    const EdgeInsets.symmetric(horizontal: 20.0, vertical: 4),
